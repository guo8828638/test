...
-(void)nextStep
{
    ...
    if ([self.dic.allKeys containsObject:self.telField.text])
    {
        

        
        UIAlertView *alertV = [[UIAlertView alloc] initWithTitle:@"提示信息" message:@"该账号已经注册过了" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        [alertV show];
