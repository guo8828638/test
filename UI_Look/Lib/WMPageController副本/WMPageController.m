...
#pragma yutao - Life Cycle
- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.edgesForExtendedLayout = UIRectEdgeNone;
    
    self.navigationItem.title = @"ILoveBRANDS";
...
#pragma yutao - UIScrollView Delegate
...
#pragma yutao - WMMenuView Delegate
